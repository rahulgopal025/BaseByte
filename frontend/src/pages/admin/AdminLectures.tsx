...
export default function AdminLectures() {
  return (
    <div className="p-8 text-white">
      <h1 className="text-4xl font-black tracking-tighter mb-1">Manage Lectures</h1>
      <p className="text-zinc-500 font-medium mb-10">Add video lectures and live session links.</p>
